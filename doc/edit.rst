...
2. Inclusion. Inclusion works by specifying the simulation name where this script as follows
...
.. code-block:: python
    ...
    model.edit_model(model_type='Models.Manager', model_name='AutomaticIrrigation', exclude = exclude_sims, returndays=3, maximumAmount=21)
