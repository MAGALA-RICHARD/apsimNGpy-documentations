...
.. py:class:: apsimNGpy.core.apsim.ApsimModel
   ...
   .. py:method:: apsimNGpy.core.apsim.ApsimModel.__init__(self, model: Union[os.PathLike, dict, str], out_path: Union[str, pathlib.Path] = <object object at 0x000001F93B12E2E0>, set_wd=None, **kwargs)
   ...
   **JSON-compatible data structures**, as commonly required during large-scale
   ...
   .. py:method:: apsimNGpy.core.apsim.ApsimModel.save(self, file_name: 'Union[str, Path]' = <object object at 0x000001F905594B60>, reload=True) (inherited)
   ...
   **kwargs
   ...
   .. py:method:: apsimNGpy.core.apsim.ApsimModel.inspect_model(self, model_type: 'Union[str, Models]', fullpath=True, scope=<object object at 0x000001F905594B60>) (inherited)
...
.. py:class:: apsimNGpy.core.config.Configuration
   ...
   .. py:method:: apsimNGpy.core.config.Configuration.__init__(self, bin_path: 'Union[Path, str]' = <object object at 0x000001F93B12D3F0>) -> None
...
.. py:class:: apsimNGpy.core.experimentmanager.ExperimentManager
   ...
   .. py:method:: apsimNGpy.core.experimentmanager.ExperimentManager.__init__(self, model, out_path=<object object at 0x000001F93B12E2E0>)
   ...
   **JSON-compatible data structures**, as commonly required during large-scale
   ...
   .. py:method:: apsimNGpy.core.experimentmanager.ExperimentManager.save(self, file_name: 'Union[str, Path]' = <object object at 0x000001F905594B60>, reload=True) (inherited)
   ...
   **kwargs
   ...
   .. py:method:: apsimNGpy.core.experimentmanager.ExperimentManager.inspect_model(self, model_type: 'Union[str, Models]', fullpath=True, scope=<object object at 0x000001F905594B60>) (inherited)
...
.. py:class:: apsimNGpy.core.mult_cores.MultiCoreManager
   ...
   MultiCoreManager(db_path: Union[str, pathlib.Path, NoneType] = (None,), agg_func: Optional[str] = None, ran_ok: bool = False, incomplete_jobs: set = <factory>)
   ...
   .. py:method:: apsimNGpy.core.mult_cores.MultiCoreManager.__init__(self, db_path: Union[str, pathlib.Path, NoneType] = (None,), agg_func: Optional[str] = None, ran_ok: bool = False, incomplete_jobs: set = <factory>) -> None
   ...
   .. py:method:: apsimNGpy.core.mult_cores.MultiCoreManager.run_all_jobs(self, jobs, *, n_cores=17, threads=False, clear_db=True, retry_rate=1, **kwargs)
   ...
   jobs : iterable or dict
       ...
       **3. Job definitions with internal model edits**
       ...
       The input dictionary is treated as metadata and is attached to the results' tables. When both inputs and
        additional metadata are provided, they are merged into a single metadata mapping prior to attachment,
        with former entries overriding earlier metadata keys and thereby avoiding duplicate keys in the results' tables.
...
.. py:function:: apsimNGpy.core.pythonet_config.get_apsim_version(bin_path: Union[str, pathlib.Path] = <object object at 0x000001F93B12E2D0>, release_number: bool = False) -> Optional[str]
...
.. py:function:: apsimNGpy.core.pythonet_config.is_file_format_modified(bin_path: Union[str, pathlib.Path] = <object object at 0x000001F93B12E2D0>) -> bool
...
.. py:function:: apsimNGpy.core.pythonet_config.load_pythonnet(bin_path: Union[str, pathlib.Path] = <object object at 0x000001F93B12E2D0>)
...
.. py:function:: apsimNGpy.core.runner.run_apsim_by_path(model: 'Union[str, Path]', *, bin_path: 'Union[str, Path, object]' = <object object at 0x000001F93B12E310>, timeout: 'int' = 800, ncores: 'int' = -1, verbose: 'bool' = False, to_csv: 'bool' = False) -> 'None'
...
.. py:function:: apsimNGpy.core.runner.run_model_externally(model: 'Union[Path, str]', *, apsim_bin_path: 'Optional[Union[Path, str]]' = <object object at 0x000001F93B12E310>, verbose: 'bool' = False, to_csv: 'bool' = False, timeout: 'int' = 20, cpu_count=-1, cwd: 'Optional[Union[Path, str]]' = None) -> 'subprocess.CompletedProcess[str]'
...
.. py:class:: apsimNGpy.core.senstivitymanager.SensitivityManager
   ...
   .. py:method:: apsimNGpy.core.senstivitymanager.SensitivityManager.__init__(self, model, out_path=<object object at 0x000001F93B12E2E0>)
   ...
   **JSON-compatible data structures**, as commonly required during large-scale
   ...
   .. py:method:: apsimNGpy.core.senstivitymanager.SensitivityManager.save(self, file_name: 'Union[str, Path]' = <object object at 0x000001F905594B60>, reload=True) (inherited)
   ...
   **kwargs
   ...
   .. py:method:: apsimNGpy.core.senstivitymanager.SensitivityManager.inspect_model(self, model_type: 'Union[str, Models]', fullpath=True, scope=<object object at 0x000001F905594B60>) (inherited)
...
.. py:function:: apsimNGpy.core_utils.database_utils.write_results_to_sql(db_path: 'Union[str, Path]', table: 'str' = 'Report', *, if_exists: 'str' = 'append', insert_fn: 'InsertFn | None' = None, ensure_parent: 'bool' = True) -> 'Callable'
