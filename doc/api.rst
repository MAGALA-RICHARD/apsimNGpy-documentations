...
.. py:class:: apsimNGpy.core.apsim.ApsimModel
   ...
   **2. Preview and edit simultaneously**
   ...
   After opening the APSIMX file in the GUI via the watching mode (``watch=True``), you can modify any parameters while in the GUI interface. The Example given below involved changing parameters such as
