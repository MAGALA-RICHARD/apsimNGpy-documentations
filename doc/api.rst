...
.. function:: apsimNGpy.optimizer._one_obj.ContVarProblem(apsim_model: 'ApsimNGpy.Core.Model', max_cache_size=400, objectives=None, decision_vars=None)
...
.. function:: apsimNGpy.optimizer._one_obj.ContVarProblem.minimize_with_a_local_solver(self, **kwargs)

   To be implimneted in sub class

.. function:: apsimNGpy.optimizer._one_obj.ContVarProblem.minimize_with_de(self)

   To be implimented in sub-class

.. function:: apsimNGpy.optimizer._one_obj.ContVarProblem.update_pbar(self, labels, extend_by=None)
...
.. function:: apsimNGpy.core.core.CoreModel.detect_model_type(self, model_instance: Union[str, Field(name='Models',type=<class 'object'>,default=<module 'Models'>,default_factory=<dataclasses._MISSING_TYPE object at 0x1077ea6f0>,init=False,repr=True,hash=None,compare=True,metadata=mappingproxy({}),kw_only=False,_field_type=_FIELD)])
...
.. function:: apsimNGpy.core.core.CoreModel.inspect_model(self, model_type: Union[str, Field(name='Models',type=<class 'object'>,default=<module 'Models'>,default_factory=<dataclasses._MISSING_TYPE object at 0x1077ea6f0>,init=False,repr=True,hash=None,compare=True,metadata=mappingproxy({}),kw_only=False,_field_type=_FIELD)], fullpath=True, **kwargs)
...
.. function:: apsimNGpy.core.core.CoreModel.inspect_model_parameters(self, model_type: Union[Field(name='Models',type=<class 'object'>,default=<module 'Models'>,default_factory=<dataclasses._MISSING_TYPE object at 0x1077ea6f0>,init=False,repr=True,hash=None,compare=True,metadata=mappingproxy({}),kw_only=False,_field_type=_FIELD), str], model_name: str, simulations: Union[str, list] = <UserOptionMissing>, parameters: Union[list, set, tuple, str] = 'all', **kwargs)
...
.. function:: apsimNGpy.core.core.CoreModel.move_model(self, model_type: Field(name='Models',type=<class 'object'>,default=<module 'Models'>,default_factory=<dataclasses._MISSING_TYPE object at 0x1077ea6f0>,init=False,repr=True,hash=None,compare=True,metadata=mappingproxy({}),kw_only=False,_field_type=_FIELD), new_parent_type: Field(name='Models',type=<class 'object'>,default=<module 'Models'>,default_factory=<dataclasses._MISSING_TYPE object at 0x1077ea6f0>,init=False,repr=True,hash=None,compare=True,metadata=mappingproxy({}),kw_only=False,_field_type=_FIELD), model_name: str = None, new_parent_name: str = None, verbose: bool = False, simulations: Union[str, list] = None)
...
.. function:: apsimNGpy.core.core.CoreModel.remove_model(self, model_type: Field(name='Models',type=<class 'object'>,default=<module 'Models'>,default_factory=<dataclasses._MISSING_TYPE object at 0x1077ea6f0>,init=False,repr=True,hash=None,compare=True,metadata=mappingproxy({}),kw_only=False,_field_type=_FIELD), model_name: str = None)
...
.. class:: apsimNGpy.optimizer._one_objContVarProblem
   ...
   .. method::apsimNGpy.optimizer._one_obj.ContVarProblem.minimize_with_a_local_solver(self, **kwargs)

      To be implimneted in sub class

   .. method::apsimNGpy.optimizer._one_obj.ContVarProblem.minimize_with_de(self)

      To be implimented in sub-class

   .. method::apsimNGpy.optimizer._one_obj.ContVarProblem.update_pbar(self, labels, extend_by=None)
...
.. class:: apsimNGpy.optimizer.singleContinuousVariable

   No documentation available.

   .. method::apsimNGpy.optimizer.single.ContinuousVariable.minimize_with_a_local_solver(self, **kwargs)
...
.. class:: apsimNGpy.optimizer._mixedMixedVarProblem
   ...
   .. method::apsimNGpy.optimizer._mixed.MixedVarProblem.minimize_with_alocal_solver(self, **kwargs)

      To be implimneted in sub class

   .. method::apsimNGpy.optimizer._mixed.MixedVarProblem.minimize_with_de(self)

      To be implimented in sub-class

   .. method::apsimNGpy.optimizer._mixed.MixedVarProblem.optimization_type(self)

      No documentation available.

.. class:: apsimNGpy.optimizer.singleMixedVariable

   No documentation available.

   .. method::apsimNGpy.optimizer.single.MixedVariable.minimize_with_alocal_solver(self, **kwargs)
   ...
   .. method::apsimNGpy.optimizer.single.MixedVariable.optimization_type(self)
