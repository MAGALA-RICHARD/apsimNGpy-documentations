...
.. admonition:: Introduction
    ...
    **Diverse model evaluation metrics**. Built-in model prediction evalaution metrics: RMSE, RRMSE, Willmott’s Index of Agreement (WIA), Bias, MAE, Lin's CCC, and :math:R^2``
